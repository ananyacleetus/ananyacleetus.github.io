...
document.querySelector(".veneration").onmouseover = function(){getInfo('Bollywood', this.className.baseVal)};
document.querySelector(".benevolence").onmouseover = function(){getInfo('Bollywood', this.className.baseVal)};
document.querySelector(".hope").onmouseover = function(){getInfo('Bollywood', this.className.baseVal)};
document.querySelector(".spirituality").onmouseover = function(){getInfo('Bollywood', this.className.baseVal)};
document.querySelector(".imitation").onmouseover = function(){getInfo('Bollywood', this.className.baseVal)};
