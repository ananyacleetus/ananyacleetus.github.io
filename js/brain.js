...
document.querySelector(".veneration").onmouseover = function(){getInfo('Too much Bollywood', this.className.baseVal)};
document.querySelector(".benevolence").onmouseover = function(){getInfo('Too much Bollywood', this.className.baseVal)};
document.querySelector(".hope").onmouseover = function(){getInfo('Too much Bollywood', this.className.baseVal)};
document.querySelector(".spirituality").onmouseover = function(){getInfo('Too much Bollywood', this.className.baseVal)};
document.querySelector(".imitation").onmouseover = function(){getInfo('Too much Bollywood', this.className.baseVal)};
