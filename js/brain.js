...
document.querySelector(".veneration").onmouseover = function(){getInfo('Every Bollywood song lyric ever', this.className.baseVal)};
document.querySelector(".benevolence").onmouseover = function(){getInfo('Every Bollywood song lyric ever', this.className.baseVal)};
document.querySelector(".hope").onmouseover = function(){getInfo('Every Bollywood song lyric ever', this.className.baseVal)};
document.querySelector(".spirituality").onmouseover = function(){getInfo('Every Bollywood song lyric ever', this.className.baseVal)};
document.querySelector(".imitation").onmouseover = function(){getInfo('Every Bollywood song lyric ever', this.className.baseVal)};
